...
public class TerrainGrid : MonoBehaviour {
    ...
    void UpdatePosition() {
        ...
        Physics.Raycast(ray, out hitInfo, Mathf.Infinity, LayerMask.GetMask("Environment"));
    ...
    void UpdateHeights() {
        ...
        for(int z = 0; z < gridHeight + 1; z++) {
            for(int x = 0; x < gridWidth + 1; x++) {
                ...
                Physics.Raycast(transform.TransformPoint(origin), Vector3.down, out hitInfo, Mathf.Infinity, LayerMask.GetMask("Environment"));
